...
from glide_shared.commands.server_modules.ft_options.ft_create_options import Field, FtCreateOptions
from glide_shared.commands.server_modules.ft_options.ft_profile_options import FtProfileOptions
from glide_shared.commands.server_modules.ft_options.ft_search_options import ConsistencyMode, FtSearchOptions, InfoScope, ShardScope
from glide_shared.constants import FtAggregateResponse, FtInfoResponse, FtProfileResponse, FtSearchResponse, TEncodable, TOK
from ..glide_client import TGlideClient

"""
module for `vector search` commands.
"""
async def create(client: TGlideClient, index_name: TEncodable, schema: List[Field], options: Optional[FtCreateOptions] = ...) -> TOK:
    """
...
async def search(client: TGlideClient, index_name: TEncodable, query: TEncodable, options: Optional[FtSearchOptions] = ...) -> FtSearchResponse:
    """
...
async def aliasadd(client: TGlideClient, alias: TEncodable, index_name: TEncodable) -> TOK:
    """
...
async def aliasupdate(client: TGlideClient, alias: TEncodable, index_name: TEncodable) -> TOK:
    """
...
async def info(client: TGlideClient, index_name: TEncodable, scope: Optional[InfoScope] = ..., shard_scope: Optional[ShardScope] = ..., consistency: Optional[ConsistencyMode] = ...) -> FtInfoResponse:
    """
...
async def explain(client: TGlideClient, index_name: TEncodable, query: TEncodable) -> TEncodable:
    """
...
async def explaincli(client: TGlideClient, index_name: TEncodable, query: TEncodable) -> List[TEncodable]:
    """
...
async def aggregate(client: TGlideClient, index_name: TEncodable, query: TEncodable, options: Optional[FtAggregateOptions] = ...) -> FtAggregateResponse:
    """
...
async def profile(client: TGlideClient, index_name: TEncodable, options: FtProfileOptions) -> FtProfileResponse:
    """
