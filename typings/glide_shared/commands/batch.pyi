...
from glide_shared.commands.core_options import ConditionalChange, ExpireOptions, ExpiryGetEx, ExpirySet, FlushMode, FunctionRestorePolicy, HashFieldConditionalChange, InfoSection, InsertPosition, UpdateOptions
...
class ClusterBatch(BaseBatch):
    ...
    """
    def copy(self, source: TEncodable, destination: TEncodable, replace: Optional[bool] = ..., destinationDB: Optional[int] = ...) -> ClusterBatch:
        """
