...
"""
def set(batch: TBatch, key: TEncodable, path: TEncodable, value: TEncodable, set_condition: Optional[ConditionalChange] = ...) -> TBatch:
    """
...
def get(batch: TBatch, key: TEncodable, paths: Optional[Union[TEncodable, List[TEncodable]]] = ..., options: Optional[JsonGetOptions] = ...) -> TBatch:
    """
...
def mget(batch: TBatch, keys: List[TEncodable], path: TEncodable) -> TBatch:
    """
...
def arrappend(batch: TBatch, key: TEncodable, path: TEncodable, values: List[TEncodable]) -> TBatch:
    """
...
def arrindex(batch: TBatch, key: TEncodable, path: TEncodable, value: TEncodable, options: Optional[JsonArrIndexOptions] = ...) -> TBatch:
    """
...
def arrinsert(batch: TBatch, key: TEncodable, path: TEncodable, index: int, values: List[TEncodable]) -> TBatch:
    """
...
def arrlen(batch: TBatch, key: TEncodable, path: Optional[TEncodable] = ...) -> TBatch:
    """
...
def arrpop(batch: TBatch, key: TEncodable, options: Optional[JsonArrPopOptions] = ...) -> TBatch:
    """
...
def arrtrim(batch: TBatch, key: TEncodable, path: TEncodable, start: int, end: int) -> TBatch:
    """
...
def clear(batch: TBatch, key: TEncodable, path: Optional[str] = ...) -> TBatch:
    """
...
def debug_fields(batch: TBatch, key: TEncodable, path: Optional[TEncodable] = ...) -> TBatch:
    """
...
def debug_memory(batch: TBatch, key: TEncodable, path: Optional[TEncodable] = ...) -> TBatch:
    """
...
def delete(batch: TBatch, key: TEncodable, path: Optional[TEncodable] = ...) -> TBatch:
    """
...
def forget(batch: TBatch, key: TEncodable, path: Optional[TEncodable] = ...) -> TBatch:
    """
    Deletes the JSON value at the specified `path` within the JSON document stored at `key`.
...
def numincrby(batch: TBatch, key: TEncodable, path: TEncodable, number: Union[int, float]) -> TBatch:
    """
...
def nummultby(batch: TBatch, key: TEncodable, path: TEncodable, number: Union[int, float]) -> TBatch:
    """
...
def objlen(batch: TBatch, key: TEncodable, path: Optional[TEncodable] = ...) -> TBatch:
    """
...
def objkeys(batch: TBatch, key: TEncodable, path: Optional[TEncodable] = ...) -> TBatch:
    """
...
def resp(batch: TBatch, key: TEncodable, path: Optional[TEncodable] = ...) -> TBatch:
    """
...
def strappend(batch: TBatch, key: TEncodable, value: TEncodable, path: Optional[TEncodable] = ...) -> TBatch:
    """
...
def strlen(batch: TBatch, key: TEncodable, path: Optional[TEncodable] = ...) -> TBatch:
    """
...
def toggle(batch: TBatch, key: TEncodable, path: TEncodable) -> TBatch:
    """
...
def type(batch: TBatch, key: TEncodable, path: Optional[TEncodable] = ...) -> TBatch:
    """
