...
class ClientSideCache:
    ...
    """
    _counter_lock: ClassVar[threading.Lock] = ...
    ...
    enable_metrics: bool = ...
    @classmethod
    def create(cls, max_cache_kb: int, entry_ttl_ms: int, eviction_policy: Optional[EvictionPolicy] = ..., enable_metrics: bool = ...) -> ClientSideCache:
        """
