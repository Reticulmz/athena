...
from caterpillar.fields.common import Transformer
...
class Compressed(Transformer[bytes, bytes, bytes, bytes]):
    ...
    """
    def __init__(self, compressor: _Compressor, struct: _StructLike[bytes, bytes] | _ContainsStruct[bytes, bytes], comp_kwargs: dict[str, Any] | None = ..., decomp_kwargs: dict[str, Any] | None = ...) -> None:
        ...
...
def compressed(lib: _Compressor, obj: _LengthTorStructT, comp_kwargs: dict[str, Any] | None = ..., decomp_kwargs: dict[str, Any] | None = ...) -> _StructLike[bytes, bytes]:
    ...

def ZLibCompressed(obj: _LengthTorStructT, comp_kwargs: dict[str, Any] | None = ..., decomp_kwargs: dict[str, Any] | None = ...) -> _StructLike[bytes, bytes]:
    """
    Create a struct representing zlib compression.
    """
    ...

def Bz2Compressed(obj: _LengthTorStructT, comp_kwargs: dict[str, Any] | None = ..., decomp_kwargs: dict[str, Any] | None = ...) -> _StructLike[bytes, bytes]:
    """
    Create a struct representing bz2 compression.
    """
    ...

def LZMACompressed(obj: _LengthTorStructT, comp_kwargs: dict[str, Any] | None = ..., decomp_kwargs: dict[str, Any] | None = ...) -> _StructLike[bytes, bytes]:
    """
    Create a struct representing lzma compression.
    """
    ...

def LZOCompressed(obj: _LengthTorStructT, comp_kwargs: dict[str, Any] | None = ..., decomp_kwargs: dict[str, Any] | None = ...) -> _StructLike[bytes, bytes]:
    """
