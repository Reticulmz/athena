...
from caterpillar.abc import _ContextLambda, _ContextLike, _EndianLike, _IT, _LengthT, _OT, _StructLike, _SupportsSetEndian, _SwitchOptionsT
...
if native_support():
    ...
    class Atom(Generic[_IT, _OT]):
        ...
        def __pack_many__(self, obj: Collection[_IT], context: _ContextLike, lengthinfo: LengthInfo) -> None:
            ...

        def __unpack__(self, context: _ContextLike) -> _OT:
            ...

        def __unpack_many__(self, context: _ContextLike, lengthinfo: LengthInfo) -> Collection[_OT]:
            ...
    ...
    class Switch(BuiltinAtom[Any, Any]):
        ...
        def __init__(self, atom: _StructLike[Any, Any] | _ContextLambda[Any], cases: _SwitchOptionsT) -> None:
            ...
        ...
        def eval_with_context(self, value: Any, context: _ContextLike) -> _StructLike[Any, Any]:
            ...
    ...
    class Conditional(BuiltinAtom[_IT | None, _OT | None]):
        ...
        def __init__(self, atom: _StructLike[_IT, _OT], condition: _ContextLambda[bool] | bool) -> None:
            ...
    ...
    class AtOffset(BuiltinAtom[_IT, _OT]):
        ...
        whence: int
        keep_pos: bool
        def __init__(self, atom: _StructLike[_IT, _OT], offset: int | _ContextLambda[int], whence: int = ..., keep_pos: bool = ...) -> None:
            ...
