...
class URL:
    ...
    * `url.query` is raw bytes, without URL escaping. A URL query string portion can
    ...
    def copy_add_param(self, key: str, value: typing.Any = ...) -> URL:
        ...
...
class QueryParams(typing.Mapping[str, str]):
    ...
    def set(self, key: str, value: typing.Any = ...) -> QueryParams:
        """
    ...
    def add(self, key: str, value: typing.Any = ...) -> QueryParams:
        """
