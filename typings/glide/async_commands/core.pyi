...
from glide_shared.commands.bitmap import BitFieldGet, BitFieldSubCommands, BitwiseOperation, OffsetOptions
from glide_shared.commands.command_args import Limit, ListDirection, OrderBy
from glide_shared.commands.core_options import ConditionalChange, ExpireOptions, ExpiryGetEx, ExpirySet, HashFieldConditionalChange, InsertPosition, OnlyIfEqual, PubSubMsg, UpdateOptions
from glide_shared.commands.sorted_set import AggregationType, GeoSearchByBox, GeoSearchByRadius, GeoSearchCount, GeoUnit, GeospatialData, InfBound, LexBoundary, RangeByIndex, RangeByLex, RangeByScore, ScoreBoundary, ScoreFilter
from glide_shared.commands.stream import StreamAddOptions, StreamClaimOptions, StreamGroupOptions, StreamPendingOptions, StreamRangeBound, StreamReadGroupOptions, StreamReadOptions, StreamTrimOptions
from glide_shared.constants import TEncodable, TOK, TResult, TXInfoStreamFullResponse, TXInfoStreamResponse

class CoreCommands(Protocol):
    async def update_connection_password(self, password: Optional[str], immediate_auth=...) -> TOK:
        """
