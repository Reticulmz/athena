...
from glide_shared.commands.server_modules.json_options import JsonArrIndexOptions, JsonArrPopOptions, JsonGetOptions
from glide_shared.constants import TEncodable, TJsonResponse, TJsonUniversalResponse, TOK
...
"""
async def set(client: TGlideClient, key: TEncodable, path: TEncodable, value: TEncodable, set_condition: Optional[ConditionalChange] = ...) -> Optional[TOK]:
    """
...
async def get(client: TGlideClient, key: TEncodable, paths: Optional[Union[TEncodable, List[TEncodable]]] = ..., options: Optional[JsonGetOptions] = ...) -> TJsonResponse[Optional[bytes]]:
    """
...
async def arrappend(client: TGlideClient, key: TEncodable, path: TEncodable, values: List[TEncodable]) -> TJsonResponse[int]:
    """
...
async def arrindex(client: TGlideClient, key: TEncodable, path: TEncodable, value: TEncodable, options: Optional[JsonArrIndexOptions] = ...) -> TJsonResponse[int]:
    """
...
async def arrinsert(client: TGlideClient, key: TEncodable, path: TEncodable, index: int, values: List[TEncodable]) -> TJsonResponse[int]:
    """
...
async def arrlen(client: TGlideClient, key: TEncodable, path: Optional[TEncodable] = ...) -> Optional[TJsonResponse[int]]:
    """
...
async def arrpop(client: TGlideClient, key: TEncodable, options: Optional[JsonArrPopOptions] = ...) -> Optional[TJsonResponse[bytes]]:
    """
...
async def arrtrim(client: TGlideClient, key: TEncodable, path: TEncodable, start: int, end: int) -> TJsonResponse[int]:
    """
...
async def clear(client: TGlideClient, key: TEncodable, path: Optional[str] = ...) -> int:
    """
...
async def debug_fields(client: TGlideClient, key: TEncodable, path: Optional[TEncodable] = ...) -> Optional[TJsonUniversalResponse[int]]:
    """
...
async def debug_memory(client: TGlideClient, key: TEncodable, path: Optional[TEncodable] = ...) -> Optional[TJsonUniversalResponse[int]]:
    """
...
async def delete(client: TGlideClient, key: TEncodable, path: Optional[TEncodable] = ...) -> int:
    """
...
async def forget(client: TGlideClient, key: TEncodable, path: Optional[TEncodable] = ...) -> Optional[int]:
    """
    Deletes the JSON value at the specified `path` within the JSON document stored at `key`.
...
async def mget(client: TGlideClient, keys: List[TEncodable], path: TEncodable) -> List[Optional[bytes]]:
    """
...
async def numincrby(client: TGlideClient, key: TEncodable, path: TEncodable, number: Union[int, float]) -> bytes:
    """
...
async def nummultby(client: TGlideClient, key: TEncodable, path: TEncodable, number: Union[int, float]) -> bytes:
    """
...
async def objlen(client: TGlideClient, key: TEncodable, path: Optional[TEncodable] = ...) -> Optional[TJsonResponse[int]]:
    """
...
async def objkeys(client: TGlideClient, key: TEncodable, path: Optional[TEncodable] = ...) -> Optional[TJsonUniversalResponse[List[bytes]]]:
    """
...
async def resp(client: TGlideClient, key: TEncodable, path: Optional[TEncodable] = ...) -> TJsonUniversalResponse[Optional[Union[bytes, int, List[Optional[Union[bytes, int]]]]]]:
    """
...
async def strappend(client: TGlideClient, key: TEncodable, value: TEncodable, path: Optional[TEncodable] = ...) -> TJsonResponse[int]:
    """
...
async def strlen(client: TGlideClient, key: TEncodable, path: Optional[TEncodable] = ...) -> TJsonResponse[Optional[int]]:
    """
...
async def toggle(client: TGlideClient, key: TEncodable, path: TEncodable) -> TJsonResponse[bool]:
    """
...
async def type(client: TGlideClient, key: TEncodable, path: Optional[TEncodable] = ...) -> Optional[TJsonUniversalResponse[bytes]]:
    """
