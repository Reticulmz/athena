...
from glide_shared.commands.core_options import FlushMode, FunctionRestorePolicy, InfoSection
from glide_shared.constants import TClusterResponse, TEncodable, TFunctionListResponse, TFunctionStatsSingleNodeResponse, TOK, TResult
from glide_shared.routes import Route
from .core import CoreCommands

class ClusterCommands(CoreCommands):
    async def custom_command(self, command_args: List[TEncodable], route: Optional[Route] = ...) -> TClusterResponse[TResult]:
        """
