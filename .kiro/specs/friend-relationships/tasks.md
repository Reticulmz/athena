...
- [ ] 1. Friend Relationship の永続化基盤を作る

- [ ] 1.1 Friend Relationship 用の DB schema と migration を追加する
...
- [ ] 1.2 Friend Relationship の repository contract と Unit of Work 境界を追加する
...
- [ ] 1.3 In-memory Friend Relationship repository を実装する
...
- [ ] 1.4 SQLAlchemy Friend Relationship repository を実装する
...
- [ ] 2. Friend-Only DM の active session state を更新できるようにする

- [ ] 2.1 SessionStore に `pm_private` 専用 update contract を追加する
...
- [ ] 2.2 Valkey SessionStore の `pm_private` 更新を atomic に実装する
...
- [ ] 3. Identity domain と command/query use-case を実装する

- [ ] 3.1 Friend Relationship domain policy を追加する
...
- [ ] 3.2 Friend add/remove command use-case を実装する
...
- [ ] 3.3 (P) Friend read query use-case を実装する
...
- [ ] 3.4 (P) Friend-Only DM session command use-case を実装する
...
- [ ] 4. Stable protocol packet surface を補完する

- [ ] 4.1 `USER_DM_BLOCKED` の stable packet builder を追加する
...
- [ ] 4.2 stable friend packet payload の parser/handler expectations を固定する
...
- [ ] 5. Login friends list と stable friend handlers を runtime に接続する

- [ ] 5.1 Login response の friends list を query-backed にする
...
- [ ] 5.2 stable friend handlers を実装する
...
- [ ] 6. Private Message delivery に Friend-Only DM policy を接続する

- [ ] 6.1 PM command に target-side Friend-Only DM policy を追加する
...
- [ ] 6.2 system response delivery と BanchoBot command path を friend-only block から分離する
...
- [ ] 6.3 stable PM handler で blocked outcome を sender-visible packet に変換する
...
- [ ] 7. Runtime wiring と test provider を完成させる

- [ ] 7.1 Repository と use-case provider wiring を追加する
...
- [ ] 7.2 import boundary と package exports を整理する
...
- [ ] 8. End-to-end behavior と regression を検証する

- [ ] 8.1 stable friend pipeline の integration tests を追加する
...
- [ ] 8.2 friend-only PM pipeline の integration tests を追加する
...
- [ ] 8.3 targeted tests と quality checks を通す
